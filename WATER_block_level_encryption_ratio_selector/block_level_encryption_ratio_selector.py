...
def main():
    ...
    logging_callback = SectionLoggingCallback(
        ...
        log_path_global_train=os.path.join(os.getcwd(), f'./WATER_block_level_encryption_ratio_selector/training_log_{currentLeakedPlaintextSize}.csv'),
    ...
    model.save(f"./WATER_block_level_encryption_ratio_selector/DQN_Block_Level_Encryption_Ratio_Selector_{currentLeakedPlaintextSize}")
    ...
    model = DQN.load(f"./WATER_block_level_encryption_ratio_selector/DQN_Block_Level_Encryption_Ratio_Selector_{currentLeakedPlaintextSize}")
    ...
    combined_test_callback = SectionLoggingCallback(
        ...
        log_path_global_test_ph=None,
        log_path_global_test_combined=os.path.join(os.getcwd(), f'./WATER_block_level_encryption_ratio_selector/testing_log_{currentLeakedPlaintextSize}.csv'),
        verbose=0
    )
