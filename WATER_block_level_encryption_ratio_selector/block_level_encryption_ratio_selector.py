...
def call_training_phase(current_leaked_plaintext_size):
    ...
    logging_callback = SectionLoggingCallback(
        ...
        log_path_global_train=os.path.join(os.getcwd(),
                                           f'./WATER_block_level_encryption_ratio_selector/training_log_{current_leaked_plaintext_size}.csv'),
    ...
    model.save(
        f"./WATER_block_level_encryption_ratio_selector/DQN_Block_Level_Encryption_Ratio_Selector_{current_leaked_plaintext_size}")

    del model

def call_validation_phase(current_leaked_plaintext_size):
    model = DQN.load(
        f"./WATER_block_level_encryption_ratio_selector/DQN_Block_Level_Encryption_Ratio_Selector_{current_leaked_plaintext_size}.zip")
...
def call_testing_phase(current_leaked_plaintext_size):
    ...
    combined_test_callback = SectionLoggingCallback(
        ...
        log_path_global_test_combined=os.path.join(os.getcwd(),
                                                   f'./WATER_block_level_encryption_ratio_selector/testing_log_{current_leaked_plaintext_size}.csv'),
        verbose=0
    )
