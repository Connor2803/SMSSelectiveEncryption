# python ./RL_model_V1_5_ELECTRICITY/RL_model_V1_5_ELECTRICITY.py
import os
...
EXECUTABLE_NAME = "generate_metrics_V1_5"
if sys.platform == "win32":
    EXECUTABLE_NAME += ".exe"
GO_SOURCE_PATH = os.path.join(SCRIPT_DIR, "generate_metrics_V1_5.go")
...
class EncryptionSelectorEnv(gym.Env):
    def __init__(self, dataset_type="train"):
        ...
        df = pd.read_csv("./RL_model_V1_5_ELECTRICITY/ML_metrics_ELECTRICITY_v1_5.csv", header=0)
        df_HE = pd.read_csv("./RL_model_V1_5_ELECTRICITY/ML_party_metrics_ELECTRICITY_v1_5.csv", header=0)
...
def main():
    ...
    log_file_name = "./RL_model_V1_5_ELECTRICITY/V1_5_training_log_ELECTRICITY.csv"
    csv_file = None
    csv_writer = None
    ...
    try:
        ...
        model.save("./RL_model_V1_5_ELECTRICITY/DQN_Encryption_Ratio_Selector_V1_5")
    ...
    # ----- VALIDATION PHASE ------
    print("\n--- Starting Validation ---")
    model = DQN.load("./RL_model_V1_5_ELECTRICITY/DQN_Encryption_Ratio_Selector_V1_5")
    ...
    with open('./RL_model_V1_5_ELECTRICITY/V1_5_testing_log_ELECTRICITY.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(log_headers)
