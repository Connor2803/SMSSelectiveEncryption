...
def run_electricity_per_block_with_policy(attack_block_size, policy_penalty):
        try:
            subprocess.run(["python", "./ELECTRICITY_block_level_encryption_ratio_selector_with_policy/block_level_encryption_ratio_selector_with_policy.py", attack_block_size, policy_penalty])
        except subprocess.CalledProcessError as e:
...
def run_water_per_block_with_policy(attack_block_size, policy_penalty):
        try:
            subprocess.run(["python", "./WATER_block_level_encryption_ratio_selector_with_policy/block_level_encryption_ratio_selector_with_policy.py", attack_block_size, policy_penalty])
        except subprocess.CalledProcessError as e:
