...
go run .\test_model_electricity\generate_test_metrics.go 2 <atdSize>
...
func main() {
	...
	if currentDataset == DATASET_WATER {
		metricsOutputFileName = "./test_model_water/ML_metrics_WATER.csv"
		partyMetricsOutputFileName = "./test_model_water/ML_party_metrics_WATER.csv"
	} else {
		metricsOutputFileName = "./test_model_electricity/ML_metrics_ELECTRICITY.csv"
		partyMetricsOutputFileName = "./test_model_electricity/ML_party_metrics_ELECTRICITY.csv"
	}
