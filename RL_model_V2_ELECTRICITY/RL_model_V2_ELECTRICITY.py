# python ./RL_model_V2_ELECTRICITY/RL_model_V2_ELECTRICITY.py 12
...
def main():
    ...
    logging_callback = SectionLoggingCallback(
        ...
        log_path_global_train=os.path.join(os.getcwd(), f'./RL_model_V2_ELECTRICITY/V2_training_log_global_{currentLeakedPlaintextSize}.csv'),
    ...
    model.save(f"./RL_model_V2_ELECTRICITY/DQN_Encryption_Ratio_Selector_V2_{currentLeakedPlaintextSize}")
    del model

    # ----- VALIDATION PHASE ------
    print("\n----- VALIDATION PHASE BEGIN ------")

    model = DQN.load(f"./RL_model_V2_ELECTRICITY/DQN_Encryption_Ratio_Selector_V2_{currentLeakedPlaintextSize}")
    ...
    combined_test_callback = SectionLoggingCallback(
        ...
        log_path_global_test_combined=os.path.join(os.getcwd(),
                                                   f'./RL_model_V2_ELECTRICITY/V2_testing_log_combined_{currentLeakedPlaintextSize}.csv'),
        verbose=0
    )
