# python ./ELECTRICITY_block_level_encryption_ratio_selector_with_policy/block_level_encryption_ratio_selector_with_policy.py <leakedPlaintextSize> <policyPenalty>
...
def call_testing_phase(current_leaked_plaintext_size: str, current_policy_penalty: int):
    ...
    combined_test_callback = SectionLoggingCallback(
        ...
        log_path_global_test_combined=os.path.join(os.getcwd(),
                                                   f'./ELECTRICITY_block_level_encryption_ratio_selector_with_policy/testing_log_{current_leaked_plaintext_size}_{current_policy_penalty}.csv'),
        verbose=0
    )
