# python ./ELECTRICITY_block_level_encryption_ratio_selector_with_policy/generate_inputs.py
...
def main():
    ...
    input_folder_path = "../examples/datasets/electricity/households_10240/"
