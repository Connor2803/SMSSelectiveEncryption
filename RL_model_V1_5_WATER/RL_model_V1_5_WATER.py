# python ./RL_model_V1_5_WATER/RL_model_V1_5_WATER.py
import os
...
class EncryptionSelectorEnv(gym.Env):
    def __init__(self, dataset_type="train"):
        ...
        df = pd.read_csv("./RL_model_V1_5_WATER/ML_metrics_WATER_v1_5.csv", header=0)
        df_HE = pd.read_csv("./RL_model_V1_5_WATER/ML_party_metrics_WATER_v1_5.csv", header=0)
...
def main():
    ...
    log_file_name = "./RL_model_V1_5_WATER/V1_5_training_log_WATER.csv"
    csv_file = None
    csv_writer = None
    ...
    try:
        ...
        model.save("./RL_model_V1_5_WATER/DQN_Encryption_Ratio_Selector_V1_5")
    ...
    # ----- VALIDATION PHASE ------
    print("\n--- Starting Validation ---")
    model = DQN.load("./RL_model_V1_5_WATER/DQN_Encryption_Ratio_Selector_V1_5")
    ...
    with open('./RL_model_V1_5_WATER/V1_5_testing_log_WATER.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(log_headers)
